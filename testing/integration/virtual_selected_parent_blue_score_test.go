...
func TestVirtualSelectedParentBlueScoreAndVirtualDAAScore(t *testing.T) {
	...
	response, err := kashd.rpcClient.GetVirtualSelectedParentBlueScore()
	if err != nil {
	...
	err = kashd.rpcClient.RegisterForVirtualSelectedParentBlueScoreChangedNotifications(
	...
	err = kashd.rpcClient.RegisterForVirtualDaaScoreChangedNotifications(
