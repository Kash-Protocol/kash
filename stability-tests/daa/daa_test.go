...
const miningAddress = "kashdev:qrcqat6l9zcjsu7swnaztqzrv0s7hu04skpaezxk43y4etj8ncwfkf2keeetr"
...
func runDAATest(t *testing.T, testName string, runDuration time.Duration,
	...
	tearDownKashd := common.RunKashdForTesting(t, "kashd-daa-test", rpcAddress)
	defer tearDownKashd()
