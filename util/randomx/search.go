...
// Search performs a hash search operation using the provided RandomX VM, input bytes, target, maximum iterations, jump, and nonce.
// It returns the hash, a boolean indicating if a solution was found, and the solution bytes.
...
// Search performs a hash search operation using this RxVM with the given input bytes, target, maximum iterations, jump, and nonce.
// It returns the hash, a boolean indicating if a solution was found, and the solution bytes.
