...
func TestAddresses(t *testing.T) {
	tests := []struct {
		...
		// Positive P2PK tests.
		{
			...
			f: func() (util.Address, error) {
				publicKey := []byte{
					...
					0xe3, 0x4c, 0xce, 0x70, 0xc8, 0x63, 0x73, 0x27, 0x3e, 0xfc,
					0xe3, 0x4c}
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixKash)
			},
		...
		},
		{
			...
			passedPrefix:   util.Bech32PrefixKash,
			expectedPrefix: util.Bech32PrefixKash,
		},
		{
			name:    "testnet p2pk",
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixKashTest)
			},
			passedPrefix:   util.Bech32PrefixKashTest,
			expectedPrefix: util.Bech32PrefixKashTest,
		},
		...
		// ECDSA P2PK tests.
		{
			...
			f: func() (util.Address, error) {
				publicKey := []byte{
					...
					0xe3, 0x4c, 0xce, 0x70, 0xc8, 0x63, 0x73, 0x27, 0x3e, 0xfc,
					0xe3, 0x4c, 0xaa}
				return util.NewAddressPublicKeyECDSA(publicKey, util.Bech32PrefixKash)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixKash,
		},
		...
		},
		{
			...
			addr:           "kash:qr35ennsep3hxfe7lnz5ee7j5jgmkjswss74as46gx",
			valid:          false,
			passedPrefix:   util.Bech32PrefixKash,
			expectedPrefix: util.Bech32PrefixKash,
		},
		...
		// Positive P2SH tests.
		{
			...
			f: func() (util.Address, error) {
				script := []byte{
					...
					0xae}
				return util.NewAddressScriptHash(script, util.Bech32PrefixKash)
			},
			passedPrefix:   util.Bech32PrefixKash,
			expectedPrefix: util.Bech32PrefixKash,
		},
		{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixKash)
			},
			passedPrefix:   util.Bech32PrefixKash,
			expectedPrefix: util.Bech32PrefixKash,
		},
		{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixKashTest)
			},
			passedPrefix:   util.Bech32PrefixKashTest,
			expectedPrefix: util.Bech32PrefixKashTest,
		},
