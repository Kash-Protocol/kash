...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a kash
...
// NewMsgDoneBlocksWithTrustedData returns a new kash DoneBlocksWithTrustedData message that conforms to the
// Message interface.
