...
// kash Addresses message (MsgAddresses).
const MaxAddressesPerMsg = 1000

// MsgAddresses implements the Message interface and represents a kash
// Addresses message.
...
// NewMsgAddresses returns a new kash Addresses message that conforms to the
