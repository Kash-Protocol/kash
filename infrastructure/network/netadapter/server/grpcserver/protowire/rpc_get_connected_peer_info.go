...
func (x *KashdMessage_GetConnectedPeerInfoRequest) toAppMessage() (appmessage.Message, error) {
	return &appmessage.GetConnectedPeerInfoRequestMessage{}, nil
}

func (x *KashdMessage_GetConnectedPeerInfoRequest) fromAppMessage(_ *appmessage.GetConnectedPeerInfoRequestMessage) error {
	return nil
}

func (x *KashdMessage_GetConnectedPeerInfoResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "KashdMessage_GetConnectedPeerInfoResponse is nil")
	}
	return x.GetConnectedPeerInfoResponse.toAppMessage()
}

func (x *KashdMessage_GetConnectedPeerInfoResponse) fromAppMessage(message *appmessage.GetConnectedPeerInfoResponseMessage) error {
	var err *RPCError
