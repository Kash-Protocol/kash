...
func (x *KashdMessage_Block) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "KashdMessage_Block is nil")
	}
	return x.Block.toAppMessage()
}

func (x *KashdMessage_Block) fromAppMessage(msgBlock *appmessage.MsgBlock) error {
