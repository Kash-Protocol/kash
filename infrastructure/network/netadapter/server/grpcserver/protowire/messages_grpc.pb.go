...
type P2P_MessageStreamClient interface {
	Send(*KashdMessage) error
	Recv() (*KashdMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *KashdMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*KashdMessage, error) {
	m := new(KashdMessage)
...
func (x *p2PMessageStreamServer) Send(m *KashdMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*KashdMessage, error) {
	m := new(KashdMessage)
...
func (x *rPCMessageStreamClient) Send(m *KashdMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*KashdMessage, error) {
	m := new(KashdMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *KashdMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*KashdMessage, error) {
	m := new(KashdMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
