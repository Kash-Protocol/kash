...
func (x *KashdMessage_GetMempoolEntryRequest) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "KashdMessage_GetMempoolEntryRequest is nil")
	}
	return x.GetMempoolEntryRequest.toAppMessage()
}

func (x *KashdMessage_GetMempoolEntryRequest) fromAppMessage(message *appmessage.GetMempoolEntryRequestMessage) error {
...
func (x *KashdMessage_GetMempoolEntryResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "KashdMessage_GetMempoolEntryResponse is nil")
	}
	return x.GetMempoolEntryResponse.toAppMessage()
}

func (x *KashdMessage_GetMempoolEntryResponse) fromAppMessage(message *appmessage.GetMempoolEntryResponseMessage) error {
	var rpcErr *RPCError
