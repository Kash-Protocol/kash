...
func (x *KashdMessage_GetBlockDagInfoRequest) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "KashdMessage_GetBlockDagInfoRequest is nil")
	}
	return &appmessage.GetBlockDAGInfoRequestMessage{}, nil
}

func (x *KashdMessage_GetBlockDagInfoRequest) fromAppMessage(_ *appmessage.GetBlockDAGInfoRequestMessage) error {
	x.GetBlockDagInfoRequest = &GetBlockDagInfoRequestMessage{}
	return nil
}

func (x *KashdMessage_GetBlockDagInfoResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "KashdMessage_GetBlockDagInfoResponse is nil")
	}
...
func (x *KashdMessage_GetBlockDagInfoResponse) fromAppMessage(message *appmessage.GetBlockDAGInfoResponseMessage) error {
	var err *RPCError
