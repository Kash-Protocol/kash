...
func (x *KashdMessage_GetUtxosByAddressesRequest) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "KashdMessage_GetUtxosByAddressesRequest is nil")
	}
	return x.GetUtxosByAddressesRequest.toAppMessage()
}

func (x *KashdMessage_GetUtxosByAddressesRequest) fromAppMessage(message *appmessage.GetUTXOsByAddressesRequestMessage) error {
...
func (x *KashdMessage_GetUtxosByAddressesResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
...
func (x *KashdMessage_GetUtxosByAddressesResponse) fromAppMessage(message *appmessage.GetUTXOsByAddressesResponseMessage) error {
	var err *RPCError
