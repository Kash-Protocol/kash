...
func (x *KashdMessage_RequestPruningPointUTXOSet) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "KashdMessage_RequestPruningPointUTXOSet is nil")
	}
...
func (x *KashdMessage_RequestPruningPointUTXOSet) fromAppMessage(
