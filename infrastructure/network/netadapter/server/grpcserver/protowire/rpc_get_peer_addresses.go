...
func (x *KashdMessage_GetPeerAddressesRequest) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "KashdMessage_GetPeerAddressesRequest is nil")
	}
	return &appmessage.GetPeerAddressesRequestMessage{}, nil
}

func (x *KashdMessage_GetPeerAddressesRequest) fromAppMessage(_ *appmessage.GetPeerAddressesRequestMessage) error {
	return nil
}

func (x *KashdMessage_GetPeerAddressesResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "KashdMessage_GetPeerAddressesResponse is nil")
	}
	return x.GetPeerAddressesResponse.toAppMessage()
}

func (x *KashdMessage_GetPeerAddressesResponse) fromAppMessage(message *appmessage.GetPeerAddressesResponseMessage) error {
	var err *RPCError
