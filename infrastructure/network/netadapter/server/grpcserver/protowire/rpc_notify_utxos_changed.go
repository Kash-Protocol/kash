...
func (x *KashdMessage_NotifyUtxosChangedRequest) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "KashdMessage_NotifyUtxosChangedRequest is nil")
	}
	return x.NotifyUtxosChangedRequest.toAppMessage()
}

func (x *KashdMessage_NotifyUtxosChangedRequest) fromAppMessage(message *appmessage.NotifyUTXOsChangedRequestMessage) error {
...
func (x *KashdMessage_NotifyUtxosChangedResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
...
func (x *KashdMessage_NotifyUtxosChangedResponse) fromAppMessage(message *appmessage.NotifyUTXOsChangedResponseMessage) error {
	var err *RPCError
...
func (x *KashdMessage_UtxosChangedNotification) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "KashdMessage_UtxosChangedNotification is nil")
	}
	return x.UtxosChangedNotification.toAppMessage()
}

func (x *KashdMessage_UtxosChangedNotification) fromAppMessage(message *appmessage.UTXOsChangedNotificationMessage) error {
