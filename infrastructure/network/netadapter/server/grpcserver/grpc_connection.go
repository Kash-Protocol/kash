...
import (
	...
	"github.com/Kash-Protocol/kashd/infrastructure/network/netadapter/server"
...
type grpcStream interface {
	Send(*protowire.KashdMessage) error
	Recv() (*protowire.KashdMessage, error)
}
...
func (c *gRPCConnection) receive() (*protowire.KashdMessage, error) {
...
func (c *gRPCConnection) send(message *protowire.KashdMessage) error {
