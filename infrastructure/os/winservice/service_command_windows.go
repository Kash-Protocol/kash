...
// installService attempts to install the kashd service. Typically this should
...
// removeService attempts to uninstall the kashd service. Typically this should
...
// startService attempts to Start the kashd service.
