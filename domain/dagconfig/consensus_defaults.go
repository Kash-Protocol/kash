...
const (
	...
	defaultSubsidyGenesisReward                    = 1 * constants.SompiPerKash
	defaultPreDeflationaryPhaseBaseSubsidy         = 500 * constants.SompiPerKash
	defaultDeflationaryPhaseBaseSubsidy            = 440 * constants.SompiPerKash
