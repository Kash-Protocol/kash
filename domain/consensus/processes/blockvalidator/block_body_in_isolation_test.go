...
var unOrderedParentsBlock = externalapi.DomainBlock{
	Header: blockheader.NewImmutableBlockHeader(
		...
		externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
			0xa2, 0xb7, 0x1e, 0xec, 0x84, 0x05, 0xf1, 0x03,
			0x04, 0xdb, 0x58, 0x00, 0x0d, 0x51, 0x38, 0x86,
			0x89, 0xb7, 0x16, 0xcf, 0xa9, 0x75, 0xe3, 0xc4,
			0x04, 0xe2, 0xdf, 0x73, 0x09, 0x57, 0x67, 0xb6,
		}),
		externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
...
var exampleValidBlock = externalapi.DomainBlock{
	Header: blockheader.NewImmutableBlockHeader(
		...
		externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
			0x1d, 0x49, 0x91, 0xf4, 0xc6, 0x69, 0x1e, 0x9b,
			0xe3, 0xed, 0x95, 0x07, 0x1d, 0xb4, 0xd5, 0x3d,
			0xf3, 0xca, 0xa6, 0x2e, 0x86, 0xd6, 0x8c, 0x6c,
			0x18, 0xd3, 0x1a, 0xe7, 0x8e, 0x15, 0xe3, 0x53,
		}),
		externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
...
var blockWithWrongTxOrder = externalapi.DomainBlock{
	Header: blockheader.NewImmutableBlockHeader(
		...
		externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
			0xca, 0x15, 0x99, 0x55, 0x58, 0x0a, 0xc5, 0xf3,
			0xb8, 0x45, 0x71, 0x8c, 0x8c, 0xf9, 0xdc, 0x92,
			0xae, 0xc1, 0xe8, 0x34, 0x0f, 0x51, 0xef, 0x6c,
			0xc2, 0x90, 0xbe, 0xad, 0x95, 0x30, 0x78, 0xa8,
		}),
		externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
